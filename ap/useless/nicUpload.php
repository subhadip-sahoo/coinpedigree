...
define('NICUPLOAD_PATH', '/home/viewdemo/pl/vipin/contractorjungle/img'); // Set the path (relative or absolute) to
// the directory to save image files

define('NICUPLOAD_URI', 'http://cj.viewthedemo.com/img');   // Set the URL (relative or absolute) to
